...
//Chapter 4 Drill, Step 11, Page 126
//Modify the previous program so that the vector elements are sorted. Print the - 
//elements to the screen at the end of the program. Be sure the elements are printed - 
//in numerical order.
...
int main()
{
    ...
    cout << "These are all of the values you entered: \n";
    for(double x : totals)
        cout << x << "m\n";

    cout << "\nGoodbye. Please come back and try again later.\n\n";
